...
const FROM = "NexaAgency <onboarding@resend.dev>";
...
<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a2e">
  <div style="background:#6c63ff;padding:24px 32px;border-radius:12px 12px 0 0">
    <h2 style="color:#fff;margin:0;font-size:20px">New Enquiry — NexaAgency</h2>
  </div>
...
<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a2e">
  ...
  <div style="background:#f9f9fc;padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
    ...
    <p style="margin:0 0 16px;line-height:1.6">Thank you for reaching out to NexaAgency. Your message has landed safely and one of our team will review it and get back to you <strong>within 24 hours</strong>.</p>
    ...
    <p style="margin:0;font-size:13px;color:#9ca3af">— The NexaAgency Team</p>
  </div>
</div>`;
}
...
<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a2e">
  <div style="background:#10b981;padding:24px 32px;border-radius:12px 12px 0 0">
    <h2 style="color:#fff;margin:0;font-size:20px">💰 Payment Received — NexaAgency</h2>
  </div>
  <div style="background:#f9f9fc;padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
...
<div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a2e">
  ...
  <div style="background:#f9f9fc;padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
    ...
    <p style="margin:8px 0 0;font-size:13px;color:#9ca3af">— The NexaAgency Team</p>
  </div>
</div>`;
}
