...
const PACKAGES = [
  {
    ...
    price: "495",
    priceNote: "one-time · or 3 × $165/mo",
    highlight: false,
    ...
    features: [
      ...
      "Template-based — fast 5-day turnaround",
  ...
  },
  {
    id: "business",
    name: "Business Site",
    tagline: "A polished, full website that generates leads and builds trust",
    price: "1,295",
    priceNote: "one-time · or 3 × $435/mo",
    highlight: false,
    icon: Zap,
    color: "text-blue-600",
    bg: "bg-blue-50",
  ...
  },
  {
    id: "ecommerce",
    name: "eCommerce",
    tagline: "Shopify or WooCommerce built to convert browsers into buyers",
    price: "1,995",
    priceNote: "one-time · or 4 × $499/mo",
    highlight: true,
    badge: "Most Popular",
    icon: Sparkles,
    color: "text-primary",
    ...
    features: [
      ...
      "Email marketing flows (abandoned cart etc.)",
  ...
  },
  {
    id: "ai-automation",
    name: "AI Automation",
    tagline: "Automate follow-ups, lead capture & repeat tasks — 24/7",
    price: "795",
    priceNote: "one-time setup · or 3 × $265/mo",
    highlight: false,
    badge: "High ROI",
    icon: Bot,
    ...
    notIncluded: ["Custom software development"],
    cta: "Automate My Business",
  },
  {
    id: "pro",
    name: "Pro / Custom",
    tagline: "Fully custom builds, web apps & complex eCommerce solutions",
    price: "3,499",
    priceNote: "starting from · payment plans available",
    highlight: false,
    icon: Code,
...
const MAINTENANCE_PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "1 hr dev time per month",
      "Priority response (8 hrs)",
    ],
    notFor: "",
  },
  {
